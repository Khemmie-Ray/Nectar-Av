...
interface INectarPool {
    ...
    struct PoolConfig {
        ...
        address token; // USDC settlement token
    ...
    function initialize(PoolConfig calldata config, address creator, address vault, address vrfModule) external;
    ...
    /// @notice Called by the configured VRF module with the finalized random word.
